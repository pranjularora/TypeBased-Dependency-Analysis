...
namespace CodeAnalysis
{
	...
	public:
		...
		std::string returnXmlPath();
		std::string returnXmlPath_SC();
		int ProfessorCodeInitialization(CodeAnalysisExecutive&, int argc, char* argv[]);
		void displayRequirement1Style();
		void displayRequirement2Style();
		void displayRequirement3Style();
		void displayRequirement4Style();
		void displayRequirement5Style();
		void displayRequirement6Style();
		void displayRequirement8Style();
		void displayRequirement9Style();
		// adding my own functionality
		//void PerformPersistance();
	...
	private:
		...
		std::string xmlPath = "DependencyFileDefaultXML.xml";
		std::string xmlPathStrongComp = "StrongComponentDefaultXML.xml";
	};
}
